  ...
  */
  ...
  return (
    <div className="card p-6">
      ...
      {/*
        Почта из формы Stripe становится логином — это нигде не говорилось, а
        человек вводит адрес, думая, что он нужен для чека. Потом опечатка в
        домене превращается в аккаунт, куда не войти и который не восстановить,
        и чинится это только руками через базу. Предупреждение стоит ДО
        перехода на Stripe: после — поздно, поле уже там.
      */}
      {live ? (
        <p className="notice notice-gold mt-4 text-sm font-normal">
          <b className="block font-bold">Почта на странице оплаты станет твоим логином</b>
          Впиши тот адрес, которым пользуешься. На него придёт подтверждение, и по нему же будешь
          входить в курс — с любого телефона.
        </p>
      ) : null}
