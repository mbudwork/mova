 ...
 * приложение, во весь экран и без адресной строки.
 *
 * Про офлайн здесь раньше было написано, что уроки работают без сети. Это
 * неправда: сервис-воркера в проекте нет, в public/ лежат только иконки.
 * Обещать покупателю работу в подвале без связи и получить пустой экран —
 * худший способ потерять доверие, поэтому обещание убрано, а не смягчено.
 *
  ...
  return (
    <aside className="card mt-8 p-5">
      ...
      <p className="mt-1 text-sm text-slate">
        Открывается как приложение — во весь экран, без адресной строки и поиска вкладки.
      </p>
