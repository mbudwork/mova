...
const RU: LandingSections = {
  ...
  pathTitle: 'Сначала общие команды. Потом — твоя профессия.',
  pathSub:
    'Общие команды слышит любой рабочий: принеси, подожди, сначала закончи это. Их учат все. Дальше добавляется то, что говорят именно твоей специальности.',
  pathProfessions: [
    'Trockenbau',
    'Fliesenleger',
    'Maler',
  ...
  pathCore: 'общие команды',
  pathProf: 'фраз твоей профессии',
  pathTotalCaption: 'фраз, которые ты услышишь на своём объекте',
  ...
  insideStats: [
    ...
    { value: '232', caption: 'общих команд' },
  ...
  priceList: [
    'Общие команды стройки — то, что слышат все',
    'Отдельный модуль твоей специальности',
...
const UK: LandingSections = {
  ...
  pathTitle: 'Спершу загальні команди. Потім — твоя професія.',
  pathSub: 'Загальні команди чує будь-який робітник: принеси, зачекай, спершу закінчи це. Їх вчать усі. Далі додається те, що кажуть саме твоїй спеціальності.',
  pathCore: 'загальні команди',
  pathProf: 'фраз твоєї професії',
  pathTotalCaption: 'фраз, які ти почуєш на своєму обʼєкті',
  ...
  priceList: [
    'Загальні команди будівництва — те, що чують усі',
    'Окремий модуль твоєї спеціальності',
