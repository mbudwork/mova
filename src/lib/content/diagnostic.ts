...
/**
 * Перемешивает элементы массива (variants: variants for a question, or the
 ...
 * слова. То же самое с порядком самих вопросов: `.order('position')` отдавал
 * их каждый раз одинаково, и второй заход на бесплатный тест был буквально
 * тем же тестом. Для бесплатного теста, который должен показать реальный
 * уровень и продать курс, это хуже, чем бесполезно: он показывает выдуманный
 * результат.
 *
